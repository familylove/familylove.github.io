...
function(a) {
	  ...
	  fff = new app52b({    // 
		...
		function getLyList(ctrid,id,pageid){          
            $.ajax({
                cache: !0,
                type: "GET",
                url: PREFIX_HOST + "?c=liuyan&a=index&id=" + id+"&pageid="+pageid+"&flag=ly",
                async: !1,
                error: function(a) {
	...
	i.addInterceptor(function(a, b, c) {
		...
		var b = document.createElement("div");
	app52guibinName=app52guibinName?app52guibinName:"您"; a.content = a.content.replace(/XXX/gi,app52guibinName);  // 不分大小写替换
		...
		var e, f = new Image; 
		console.log('addComponent("3" ' , a.properties.imgSrc);
		return a.properties.imgSrc ? (e = a.properties.imgSrc, e.indexOf("http://") > -1 ? (f.src = e, d.style.backgroundImage = "url(" + e + ")") : (f.src = PREFIX_FILE_HOST + "/" + e, d.style.backgroundImage = "url(" + PREFIX_FILE_HOST   + e + ")"), console.log('addComponent e',e),d.style.backgroundOrigin = "element content-box", d.style.backgroundSize = "cover", d.style.backgroundPosition = "50% 50%", a.effect && ("scaleUp" == a.effect.type ? $(d).css({
	...
	}), i.addComponent("U", function(app52a) {  
		var app52K = document.createElement("a");
		if(app52a.properties.imgSrc){app52K.style.background="url("+ (app52a.properties.imgSrc.indexOf('http://') < 0 ? PREFIX_FILE_HOST+app52a.properties.imgSrc : app52a.properties.imgSrc)+")";app52K.style.backgroundSize="100% 100%";}
	    if(typeof(app52a.properties.src.app52province) ==  'undefined' || typeof(app52a.properties.src.app52city) ==  'undefined'){
		  app52a.properties.src.app52province='';
		  app52a.properties.src.app52city = '';
		}
		return app52K.setAttribute("class", "element map_area"), app52K.id = app52a.id, app52K.setAttribute("ctype", app52a.type), app52a.properties.src && app52K.setAttribute("href", "#"), app52K.setAttribute("hotel", app52a.properties.src.hotel), app52K.setAttribute("tel", app52a.properties.src.tel), app52K.setAttribute("app52province", app52a.properties.src.app52province),app52K.setAttribute("app52city", app52a.properties.src.app52city),app52K.setAttribute("address", app52a.properties.src.address), app52K.setAttribute("lat", app52a.properties.src.lat), app52K.setAttribute("lng", app52a.properties.src.lng), app52K
	}), i.addComponent("u", function(a) {
		var b = document.createElement("div");
            b.id = "map_" + a.id,b.setAttribute("class", "element comp_map_wrapper baidustatusmap");           
            setTimeout(function(){ 
                var zoom = a.properties.src.zoom?a.properties.src.zoom:14;
                var map = new BMap.Map(b);
                var point = new BMap.Point(a.properties.src.lng, a.properties.src.lat);
		...
		if (a = $("div", a)[0], "view" == i.mode && 1 == b.type) {
            ...
            if( "view" == i.mode ){
				...
				var app_52item3= b.properties.app52lyitem3 !=undefined && b.properties.app52lyitem3!="" ?b.properties.app52lyitem3 : "留言内容";			
				 var html='<ul class="myform" id="ccform' + b.id + '"> <li comp-drag="" comp-rotate="" class="comp-resize comp-rotate inside wsite-input" id="inside_788" num="1" ctype="501" comp-resize="" style="width: 96px; height: 30px; left: 5px; top: 0px; z-index: 201;"><div class="element-box" style="top: 2px; left: 5px; z-index: 201; color: rgb(103, 103, 103); border: 1px solid rgb(204, 204, 204); width: 100%; height: 100%; transform: none; background-color: rgb(249, 249, 249);"><div class="element-box-contents" style="width: 100%; height: 100%;"><textarea id="788" ctype="501" class="element comp_input editable-text" required="required" placeholder="' + app_52item1 + '" name="eq[f_788]" style="width: 96px; height: 31px;"></textarea></div></div></li>'+
				 '<li comp-drag="" comp-rotate="" class="comp-resize comp-rotate inside wsite-input" id="inside_1111" num="1" ctype="502" comp-resize="" style="width: 130px; height: 31px; left: 100px; top: 0px; z-index: 204;position: absolute;"><div class="element-box" style="top: 2px; left: 105px; z-index: 4; color: rgb(103, 103, 103); border: 1px solid rgb(204, 204, 204); background-color: rgb(249, 249, 249); width: 100%; height: 100%; -webkit-transform: none;"><div class="element-box-contents" style="width: 100%; height: 100%;"><textarea id="1111" ctype="502" class="element comp_input editable-text" placeholder="' + app_52item2 + '" name="eq[f_1111]" style="width: 130px; height: 32px;"></textarea></div></div></li>'+	
				'<li comp-drag="" comp-rotate="" class="comp-resize comp-rotate inside wsite-input" id="inside_140" num="1" ctype="5" comp-resize="" style="width: 230px; height: 50px; left: 4px; top: 37px; z-index: 202;margin-top: 2px;"><div class="element-box" style="top: 37px; left: 4px; z-index: 2; color: rgb(103, 103, 103); border: 1px solid rgb(204, 204, 204); width: 100%; height: 100%; transform: none; background-color: rgb(249, 249, 249);"><div class="element-box-contents" style="width: 100%; height: 100%;"><textarea id="140" ctype="5" class="element comp_input editable-text" required="required" placeholder="请输入' + app_52item3 + '" name="eq[f_140]" style="width: 222px; height: 55px;"></textarea></div></div></li>'+
				 '<li comp-drag="" comp-rotate="" class="comp-resize comp-rotate inside wsite-button" id="inside_268" num="1" ctype="6" comp-resize="" style="width: 78px; height: 81px; right: 2px; top: 1px; z-index: 203;position: absolute;"><div class="element-box" style="top: 1px; right: 2px; z-index: 3;   border: 1px solid rgb(204, 204, 204); width: 100%; height: 100%; transform: none; /* background-color: rgb(249, 249, 249); */"><div class="element-box-contents" style="width: 100%; height: 100%;"><button id="mysubmit' + b.id + '" ctype="6" class="element comp_button editable-text" style="width: 78px; height: 91px;  z-index: 52525252; ">提交</button></div></div></li></ul>'+
					...
					$("#mysubmit" + b.id).bind("click", function() {
                     ...
                     var d = !0,
						...
						$("textarea", e).each(function() {
							...
							cache: !0,
							type: "POST",
							url: PREFIX_HOST + "?c=scenedata&a=add&id=" + b.sceneId+"&pageid="+b.pageId+"&flag=ly",
							data: $.param(f),
							async: !1,
							error: function(a) {
								alert("Connection error")
		...
		if ("view" == i.mode) {
			var d = function() {
					$.ajax({
						cache: !0,
						type: "POST",
						url: PREFIX_URL + "index.php?c=scene&a=dial",
						data: $.param(c),
						async: !1,
						error: function(a) {
							alert("Connection error")
	...
	}),i.bindAfterRenderEvent("U", function(L,K) { 
		"view" == i.mode && $(L).click(function() {	
		  $('<div id="maparea_' + K.id + '" class="u-app52_cn_ndaomap"></div>').appendTo($(L).closest(".m-img"));
			contentCode = K.properties.src.tel == "" ? K.properties.src.address : '电话：<a href="tel:' + K.properties.src.tel + '"><u>' + K.properties.src.tel + "</u></a><br>" + K.properties.src.address;
			map_data = {
				lng: K.properties.src.lng,
				lat: K.properties.src.lat,
				title: "" + K.properties.src.hotel,
				tel:K.properties.src.tel,
				address: K.properties.src.address
			};
			//var M = new app52Map2($("#maparea_" + K.id), map_data);
		   $("#maparea_" + K.id).app52Map2(map_data);
		})
		...
		if ("view" == i.mode) {
			...
			d.click(function(e) {
				...
				$.ajax({
					cache: !0,
					type: "POST",
					url: PREFIX_S1_URL + "?c=scene&a=counterset",
					data: $.param(f),
					async: !1,
					error: function(a) {
						alert("Connection error")
			...
			wx.uploadVoice({
				...
				success: function(res) {
					...
					$.ajax({
						cache: !1,
						type: "GET",
						url: "index.php?c=liuyan&a=saveUploadVoice",
						data: $.param({
							mediaid: c,
			...
			N = function(a, b, c, e) {
				...
				n = function(a) {
					...
					if (I && completeEffect($(m.$currentPage))) if (I = !1, m.$activePage) {
						...
						m._pageData[c].properties && m._pageData[c].properties.longPage && ($(m.$activePage).find(".edit_area").css("transform", "translateY(0px)"), $(m.$activePage).find(".edit_area").css("-webkit-transform", "translateY(0px)"), $(document).trigger("clearTouchPos"))
...
function(a, b) {
		...
		ad = 2, $.ajax({
			...
			success: function(c) {
				...
				for (d.length; f < d.length; f++) {
					...
					else if (a.obj.property.bottomLabel.name) 2 == g.type && g.content.indexOf("APP52.CN科技公司") > 0 && (g.content = g.content.replace(/APP52.CN科技公司/, a.obj.property.bottomLabel.name));
					else if (/APP吾爱技术支持/.test(g.content)) {
	...
	function parsePage(a, b) {
		...
		for (var j = 1; j <= a.length; j++) {
			...
			}), d || (d = !0, $.getScript(CLIENT_CDN + "view/js/app52kiss.js", function(b, d, e) {
	...
	function getCounterValues(a) {
		...
		$.each(a.list, function(a, c) {
			...
			type: "GET",
			url: PREFIX_S1_URL + "?c=scene&a=countervalues",
			data: $.param(b),
			xhrFields: {
				withCredentials: !0
			},
	...
	function getRequestUrl() {
		var a;
		if (preview) a = isNewPreviewLocation ? PREFIX_URL + "index.php?c=scene&a=view&id="+sceneId+"&preview=preview" + ".data" : PREFIX_URL + "index.php?c=scene&a=view&id="+sceneId+"&preview=preview&app52from="+app52from, branchid && (a += (/\?/.test(a) ? "&" : "?") + "user=" + branchid);
		else {
			if (!mobileview) {
				a = window.scene && window.scene.id ? window.isCheck ? MAX_SERVER_HOST + "m/eqs/view/page/" + window.scene.id : PREFIX_S1_URL + "index.php?c=scene&a=view&id=" + window.scene.id +"&app52from="+app52from: PREFIX_URL + "index.php?c=scene&a=view&id=" + sceneId+"&app52from="+app52from;
